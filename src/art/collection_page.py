...
def get_recent(collection_id):
    ...
    data = dynamodb.Table('art').query(
        ...
        ProjectionExpression='click_count, art_url, art_id, preview_url, #n, tags, last_sale_price, open_sea_data.description, description, collection_id'
    )
    ...
    while 'LastEvaluatedKey' in data and len(uploads) < 250:
        data = dynamodb.Table('art').query(
            ...
            IndexName='collection_id-recent_sk-index',
            ExpressionAttributeNames={'#n': 'name'},
            ProjectionExpression='click_count, art_url, art_id, preview_url, #n, tags, last_sale_price, collection_address, open_sea_data.description, description, collection_id',
